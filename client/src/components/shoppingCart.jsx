...
const ShoppingCart = ({ supplements }) => {
  ...
  return (
    <div className="container mx-auto py-12 bg-[#1F1F1F]">
      <h2 className="text-2xl font-semibold mb-8 text-white">Shopping Cart</h2>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-gray-200 text-white">
        <span className="text-lg font-semibold text-black-500">Total</span>
        <span className="text-lg font-semibold">BDT {total.toFixed(2)}</span>
      </div>
