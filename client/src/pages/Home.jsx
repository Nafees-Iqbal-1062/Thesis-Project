import aboutCover from "../assets/IMG_9821.jpg";
import workoutCover from "../assets/workoutCover.png";
import membershipCover from "../assets/IMG_9827.jpg";
...
export default function Home() {
  return (
    <>
      <div className="w-full h-screen bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('./assets/homebg2.webp')] bg-center bg-cover">
        {/* <img
          src={homebg}
          alt="homebg"
        ...
        <div className="flex flex-col gap-6 p-40 px-4 max-w-6xl mx-auto">
          ...
          <button className="text-black py-2 px-6 font-semibold uppercase rounded-full bg-white hover:bg-black hover:text-white">
              Join now
            </button>
            <button className="text-[#d4d4d4] py-2 px-6 font-semibold uppercase rounded-full border-2 border-white hover:border-gray-300 mx-6">
              Learn more
            </button>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:p-10">
            <div className="p-2 relative flex items-center">
              ...
              <div className="absolute bottom-5 left-0  text-[#d4d4d4] p-4">
                ...
                <p className="text-2xl font-bold ">BM FITNESS WORLD.</p>
              </div>
            </div>
      ...
      <div className="relative w-full h-screen bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('./assets/girl-fitness.png')] bg-center bg-cover flex items-end">
      ...
      <div className="bg-[#1f1f1f] py-10">
        <div className="relative w-full h-screen bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.8),rgba(0,0,0,0.6)),url('./assets/supplements.webp')] bg-center bg-cover">
