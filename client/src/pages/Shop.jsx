...
const Shop = () => {
    ...
    < div className="bg-black">
      ...
      <div className="bg-red-800 p-4 flex items-center justify-between">
        ...
        <div className="flex justify-center">
          <button
            className="px-4 py-2 mr-3 text-white text-l"
          ...
          <button
            className="px-4 py-2 text-white text-l"
  ...
  /> */}
      ...
      <div className="mt-12 mx-auto max-w-7xl px-4">
        <h1 className="text-4xl font-extrabold italic mb-8 text-center text-white dark:text-gray-200">
